...
/**
 * Postcalc free shipping method selector model
 *
 * @category Astrio
 * @package  Astrio_Postcalc
 * @author   Vladimir Khalzov <v.khalzov@astrio.net>
 */
class Astrio_Postcalc_Model_Shipping_Carrier_Postcalc_Source_Freemethod
    extends Astrio_Postcalc_Model_Shipping_Carrier_Postcalc_Source_Method
{
    /**
